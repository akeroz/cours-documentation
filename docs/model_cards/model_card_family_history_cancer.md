# Model Card: Prédiction de `family_history_cancer`

**Date de développement:** 2026-01-09  
**Version:** 1.0  
**Variable cible:** `family_history_cancer`
...
- **Distribution de la variable cible:**
  - Classe 0: 3983 échantillons
  - Classe 1: 1017 échantillons
...
**Note:** La variable `family_history_cancer` a été exclue des features lors de l'entraînement.
...
with open('models/model_family_history_cancer.pkl', 'rb') as f:
    model = pickle.load(f)
